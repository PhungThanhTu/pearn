...
const { httpCreateMarkdownBlock, httpGetAllBlocks, httpGetBlock, httpUpdateMarkdownBlock, httpDeleteBlock, httpCreateMarkdownExerciseBlock, httpChangeBlockName } = require('../services/block.service');
...
router.post('/',authorize("lecturer"),httpCreateMarkdownBlock);
...
router.patch('/:blockId',authorize("lecturer"),httpChangeBlockName)
